...
public class ConsultaClienteGUI extends javax.swing.JInternalFrame {

    private ClienteController clienteController = new ClienteController();
    private boolean ConsultaClienteVendaGUI;
    private VendaGUI vendaGUI = null;
    private ClienteVO clienteVO = new ClienteVO();
    private boolean ConsultaClienteConsultaVendasGUI;
    ...
    public ConsultaClienteGUI(VendaGUI vendaGUI) {
        this.vendaGUI = vendaGUI;
        this.ConsultaClienteVendaGUI = true;
        initComponents();
        atalhoTeclado();
        formatarCampos();
        jScrollPane1.setVisible(false);
    ...
    public ConsultaClienteGUI(ConsultaVendasGUI consultaVendasGUI) {
        this.consultaVendasGUI = consultaVendasGUI;
        this.ConsultaClienteConsultaVendasGUI = true;
        initComponents();
        atalhoTeclado();
        formatarCampos();
        jScrollPane1.setVisible(false);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jTextNome, javax.swing.GroupLayout.DEFAULT_SIZE, 251, Short.MAX_VALUE))
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            int clienteId = (Integer) jTable1.getValueAt(row, 0);
            if (ConsultaClienteVendaGUI) {
                vendaGUI.setCodigoCliente(clienteId);
                this.dispose();
            }else if (ConsultaClienteConsultaVendasGUI) {
                consultaVendasGUI.setCodigoCliente(clienteId);
                this.dispose();
            } else {
                editar();
            }
    ...
    public class ClienteTableModel extends DefaultTableModel {
        public ClienteTableModel() {
            super(new Object[][] {},
                    new String[] {"Código", "Nome", "Limite de Compra", "Dia de Fechamento"});
        }
        public boolean isCellEditable(int row, int column) {
            return false;
        }
    ...
    private void consultar() throws HeadlessException {
        clienteVO.setNome(jTextNome.getText().isEmpty() ? null : jTextNome.getText());
        clienteVO.setId(jTextCodigo.getText().isEmpty() ? null : Integer.parseInt(jTextCodigo.getText()));
        jScrollPane1.setVisible(true);
        revalidate();
        repaint();
        List<ClienteVO> consultarClientes = clienteController.consultarClientes(clienteVO);
        DefaultTableModel model = new ClienteTableModel();
        jTable1.setModel(model);
        model.setRowCount(0);
        for (ClienteVO c : consultarClientes) {
            model.addRow(new Object[]{c.getId(), c.getNome(), c.getLimitecompra(), c.getDiafechamento()});
        }
    }
    ...
    public void excluir() throws HeadlessException {
        ...
        if (row != -1) {
            ...
            try {
                clienteVO = clienteController.consultarCliente(id);
